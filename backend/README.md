...
## Project Structure
    ...
    ├── studio_long_load_te_37979  # Django project configurations
...
1. Clone this repo and `cd studio_long_load_te_37979`
...
2. Clone this repo and `cd studio_long_load_te_37979`
